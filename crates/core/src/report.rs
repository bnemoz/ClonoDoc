...
pub fn html_report(project_name: &str, gate1: &[Gate1Verdict], gate2: &[Gate2Verdict]) -> String {
    ...
    s.push_str(&format!(
        "<!doctype html><html><head><meta charset=\"utf-8\"><title>ClonoDoc — {}</title>",
    ...
    s.push_str("<p class=\"reason\" style=\"margin-top:2rem\">Generated by ClonoDoc.</p>");
